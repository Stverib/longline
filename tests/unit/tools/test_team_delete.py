"""Tests for longline.tools.team.team_delete_tool — TeamDeleteTool."""
...
async def test_delete_team(tool: TeamDeleteTool, tmp_path: Path) -> None:
    ...
    with patch("longline.swarm.team_file._DEFAULT_CLAUDE_DIR", tmp_path):
        team = TeamFile(
            name="rm-team",
        ...
        with patch("longline.tools.team.team_delete_tool._get_team_dir") as mock_dir:
