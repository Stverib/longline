"""Tests for longline.prompts.teammate_prompt — teammate prompt addendum."""

from __future__ import annotations

from longline.prompts.teammate_prompt import (
...
class TestBuildTeammatePromptAddendum:
    ...
    def test_includes_team_config_path(self) -> None:
        ...
        assert "~/.longline/teams/my-proj/config.json" in prompt
