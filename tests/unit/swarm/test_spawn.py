"""Tests for longline.swarm.spawn — teammate spawning with real execution."""
...
from longline.swarm.spawn import get_running_tasks, spawn_teammate
from longline.swarm.team_file import TeamFile, TeamMember, load_team_file, save_team_file
...
async def test_spawn_returns_task_id(claude_dir: Path) -> None:
    ...
    with patch("longline.swarm.team_file._DEFAULT_CLAUDE_DIR", claude_dir):
