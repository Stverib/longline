"""Tests for longline.swarm.coordinator — coordinator mode detection."""

from __future__ import annotations

from typing import TYPE_CHECKING

from longline.swarm.coordinator import get_coordinator_config, is_coordinator_mode
...
class TestGetCoordinatorConfig:
    def test_returns_dict(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        assert config["env_var"] == "LONGLINE_COORDINATOR_MODE"
