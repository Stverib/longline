...
class InProcessTeammate:
    ...
    async def _execute_with_query_loop(self, task: str) -> str:
        ...
        from longline.prompts.sections import DEFAULT_AGENT_PROMPT
        from longline.prompts.teammate_prompt import build_teammate_prompt_addendum
        from longline.swarm.identity import TEAM_LEAD_NAME
        from longline.swarm.mailbox import TeammateMailbox, TeammateMessage
        from longline.tools.base import ToolRegistry
