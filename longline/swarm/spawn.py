...
from longline.swarm.in_process_runner import InProcessTeammate
from longline.swarm.team_file import TeamMember, add_member
...
async def spawn_teammate(
    ...
    # --- 第 1 步：注册到 team file ---
    # 将 teammate 信息持久化到 ~/.longline/teams/{team}/config.json
    ...
    def _on_done(t: asyncio.Task[str]) -> None:
        ...
        if task_registry is not None:
            from longline.session.task_registry import TaskState
