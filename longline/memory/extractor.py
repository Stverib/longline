...
from longline.memory.session_memory import load_memories, save_memory, update_memory_index

if TYPE_CHECKING:

    from longline.models.messages import Message
...
async def extract_memories(
    ...
    Args:
        ...
        claude_dir: Override for ~/.longline directory (for testing).
...
Analyze the above and extract any memories worth saving."""
    ...
    from longline.models.messages import normalize_messages_for_api
