...
=== 模块关系 ===
  ...
  产出方: longline/core/query_loop.py（主循环）、longline/api/claude.py（流式解析）
  消费方: longline/ui/renderer.py（渲染）、longline/main.py（token 统计）、longline/core/query_engine.py（透传）
"""
